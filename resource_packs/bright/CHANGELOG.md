...
## [2.0.0] (1.21.90) - unreleased

### General

- Changed `#bright` suffix to `@bright`
- Namespace has changed to `lpsm_bright`
- Blocks are now organized into groups in the construction tab.
